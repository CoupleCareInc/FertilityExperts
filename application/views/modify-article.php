<?php 
	...
	foreach ($article_data as $row) {
		...
		$article_datecreated = $row->datecreated;
			...
			<div class="container">
				...
				<?php echo form_open('articles/action'); ?>
					<div class="row uniform">
						<div class="12u"><input type="text" name="title" id="subject" value="<?= $article_title; ?>" /></div>
					</div>
					<div class="row uniform">
						<div class="12u"><input type="text" name="subtitle" id="subject" value="<?= $article_subtitle; ?>" /></div>
					</div>
					<div class="row uniform">
						...
						<div class="12u"><textarea name="content" id="textarea" rows="8"><?= $article_content; ?></textarea></div>
					</div>
